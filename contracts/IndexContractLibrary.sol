...
library IndexContractLibrary {
    ...
    function setEntry(Data storage data, string name, bytes32 value) public {
    ...
    function getEntry(Data storage data, string name) public view returns (bytes32) {
        return data.entries[keccak256(name)].value;
    }
}
