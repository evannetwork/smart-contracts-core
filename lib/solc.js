...
const librariesAddresses = {
  core: {
    'ENS': '0xc913ac6522344187bc9C88C9f9302b005500FfF9',
    'verifications/KeyHolderLibrary.sol:KeyHolderLibrary': '0x9712325360aE316c333ACc0714170E49594d9592',
    'verifications/VerificationHolderLibrary.sol:VerificationHolderLibrary': '0x00b4Ff1176255a3cF06207A03B5b45D76DFBF4B6',
    'verifications/VerificationsRegistryLibrary.sol:VerificationsRegistryLibrary': '0x3d722d4AE00Ef88C5C4c51fC19C3B257e6d3D11E',
    'DSRolesPerContractLibrary.sol:DSRolesPerContractLibrary': '0x6a7631d3C7A7E89eA0Cfcc13D783D629102D14a1',
    'BaseContractZeroLibrary.sol:BaseContractZeroLibrary': '0x080B98aFc055C1c9d9672dd5A89b93Ef9173792b',
    'DataContractLibrary.sol:DataContractLibrary': '0xA52304742c86bAB72Ae070fAb0580A43731781f3',
    'DigitalTwinLibrary.sol:DigitalTwinLibrary': '0x21c89be4C8990413B1C225aAc91BFb7a74f33cC4',
  },
  testcore: {
    'ENS': '0xd9b054d2FFA8Cf301885Af53db86971881E2EA54',
    'verifications/KeyHolderLibrary.sol:KeyHolderLibrary': '0xcd4F22D95C62aad0B12e5493c3264629800B6740',
    'verifications/VerificationHolderLibrary.sol:VerificationHolderLibrary': '0x683a11d929c5D632aF6dF0A817E27472789A4032',
    'verifications/VerificationsRegistryLibrary.sol:VerificationsRegistryLibrary': '0x72f16ab675AcaDf5dce9CB51560F7E279A770465',
    'DSRolesPerContractLibrary.sol:DSRolesPerContractLibrary': '0x8e313491891f2d2218DECac8cE4eAF79Be368a13',
    'BaseContractZeroLibrary.sol:BaseContractZeroLibrary': '0x9efAFEe1c35f44639E68b56084B42017A7e6E81F',
    'DataContractLibrary.sol:DataContractLibrary': '0x90fF98a57176169e555B66f7e05ff5dEab9a1992',
    'DigitalTwinLibrary.sol:DigitalTwinLibrary': '0x21c89be4C8990413B1C225aAc91BFb7a74f33cC4',
  }
};
...
class Solc {
  ...
  async compileContracts(src_tree, dst) {
    ...
    if (chain !== 'testnet') {
      const ensRegex = new RegExp(librariesAddresses.testcore.ENS, 'i');
      for (let f in solFiles) {
        solFiles[f] = (await solFiles[f]).replace(ensRegex, librariesAddresses[chain].ENS);
      }
    }
