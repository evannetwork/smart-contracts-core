...
const libraryLinks = {
  'verifications/VerificationHolder.sol:VerificationHolder': {
    'verifications/VerificationHolderLibrary.sol:VerificationHolderLibrary': '0xFDb2b28f481D9FEbB55Cea18131C8d96b18D16bB',
    'verifications/KeyHolderLibrary.sol:KeyHolderLibrary': '0x53943BD308f3CB0E79Cb4811288dB1AB2AaFa6b2',
  },
  'verifications/VerificationHolderLibrary.sol:VerificationHolderLibrary': {
    'verifications/KeyHolderLibrary.sol:KeyHolderLibrary': '0x53943BD308f3CB0E79Cb4811288dB1AB2AaFa6b2',
  },
  'verifications/KeyHolder.sol:KeyHolder': {
    'verifications/KeyHolderLibrary.sol:KeyHolderLibrary': '0x53943BD308f3CB0E79Cb4811288dB1AB2AaFa6b2',
  },
  'verifications/VerificationsRegistry.sol:VerificationsRegistry': {
    'verifications/VerificationsRegistryLibrary.sol:VerificationsRegistryLibrary': '0xb1621be2ef1F2dC5153B2487600CcC1E4Fa7ee27',
  },
};
...
class Solc {
  ...
  async writeContractsToFile(contracts, dst) {
    ...
    Object.keys(uiContracts).forEach((key) => {
      if (uiAllowedByteCodes.indexOf(key) === -1) {
