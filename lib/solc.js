...
const allowedByteCodes = [
  'claims/ClaimHolder.sol:ClaimHolder',
  'claims/ClaimsRegistry.sol:ClaimsRegistry',
];

// dependencies between libraries
const libraryDependencies = {
  'claims/ClaimHolderLibrary.sol:ClaimHolderLibrary': ['claims/KeyHolderLibrary.sol:KeyHolderLibrary'],
...
const librariesAddresses = {
  'claims/ClaimHolderLibrary.sol:ClaimHolderLibrary': '0xff15b356115ee908B75caf36525619BE34a6f006',
  'claims/ClaimsRegistryLibrary.sol:ClaimsRegistryLibrary': '0x36EF1f5dc0DA8d08dE6dF9Ae34c899515994A189',
  'claims/KeyHolderLibrary.sol:KeyHolderLibrary': '0x7b58Df930039cFB34630fED3dD0766b8578DdaDa',
  'DSRolesPerContractLibrary.sol:DSRolesPerContractLibrary': '0x62CcffCDADC528459461b3F81526D00C28Db7d65',
  'BaseContractZeroLibrary.sol:BaseContractZeroLibrary': '0x58859fbc7212034785F33Fa663f6074e9e10e90A',
  'DataContractLibrary.sol:DataContractLibrary': '0x5ed046a991F88E8e0253B9FDcB8aBB69204d732a',
};
...
class Solc {
  ...
  constructor(options) {
    ...
    this.config.allowedByteCodes = allowedByteCodes.concat(options.allowedByteCodes || []);
  ...
  async writeContractsToFile(contracts, dst) {
    ...
    Object.keys(contracts).forEach((key) => {
      if (this.config.allowedByteCodes.indexOf(key) === -1) {
    ...
    const jsContentContracts = JSON.parse(JSON.stringify(contracts));
    Object.keys(jsContentContracts).forEach((key) => { delete jsContentContracts[key].deployedAt; });
    const jscontent = `(function (root, factory) {
        ...
        return ${JSON.stringify(jsContentContracts)};
      }));`
    if (destinationPath) {
