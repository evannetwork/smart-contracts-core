...
const libraryLinks = {
  ...
  'claims/ClaimHolderLibrary.sol:ClaimHolderLibrary': {
    'claims/KeyHolderLibrary.sol:KeyHolderLibrary': '0x53943BD308f3CB0E79Cb4811288dB1AB2AaFa6b2',
  },
  'claims/KeyHolder.sol:KeyHolder': {
    'claims/KeyHolderLibrary.sol:KeyHolderLibrary': '0x53943BD308f3CB0E79Cb4811288dB1AB2AaFa6b2',
  },
  ...
  linkLibraries(contracts) {
    ...
    Object.keys(contracts).map((contract) => {
      contracts[contract].bytecode = linker.linkBytecode(
        contracts[contract].bytecode,
        {
          'DSRolesPerContractLibrary.sol:DSRolesPerContractLibrary': '0x079e982514861F1314D014CA9f8aFF5750b47e25',
          'BaseContractZeroLibrary.sol:BaseContractZeroLibrary': '0x847B7DF3a2B6455bc13E0485f009507Ee13bDB2C',
          'DataContractLibrary.sol:DataContractLibrary': '0x1a5bB7C02b00712927D24B1d65F40c0eB4102e5B',
        },
      )
    })
  }
